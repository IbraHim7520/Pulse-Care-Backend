...
-- CreateTable
CREATE TABLE "paitent_health_data" (
    "id" TEXT NOT NULL,
    "gender" "Gender" NOT NULL,
    "dateOfBirth" TIMESTAMP(3) NOT NULL,
    "boodGroup" "BloodGroup" NOT NULL,
    ...
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
    "paitenId" TEXT NOT NULL,

    CONSTRAINT "paitent_health_data_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE INDEX "appointments_paitentId_idx" ON "appointments"("paitentId");
...
-- CreateIndex
CREATE INDEX "medical_reports_paitentId_idx" ON "medical_reports"("paitentId");

-- CreateIndex
CREATE UNIQUE INDEX "paitent_health_data_paitenId_key" ON "paitent_health_data"("paitenId");

-- CreateIndex
CREATE INDEX "paitent_health_data_paitenId_idx" ON "paitent_health_data"("paitenId");

-- CreateIndex
CREATE UNIQUE INDEX "payments_transictionId_key" ON "payments"("transictionId");
...
-- CreateIndex
CREATE INDEX "payments_transictionId_idx" ON "payments"("transictionId");
...
-- CreateIndex
CREATE INDEX "prescriptions_paitentId_idx" ON "prescriptions"("paitentId");
...
-- CreateIndex
CREATE INDEX "reviews_paitentId_idx" ON "reviews"("paitentId");
...
-- AddForeignKey
ALTER TABLE "appointments" ADD CONSTRAINT "appointments_paitentId_fkey" FOREIGN KEY ("paitentId") REFERENCES "paitent"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "medical_reports" ADD CONSTRAINT "medical_reports_paitentId_fkey" FOREIGN KEY ("paitentId") REFERENCES "paitent"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "paitent_health_data" ADD CONSTRAINT "paitent_health_data_paitenId_fkey" FOREIGN KEY ("paitenId") REFERENCES "paitent"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "prescriptions" ADD CONSTRAINT "prescriptions_paitentId_fkey" FOREIGN KEY ("paitentId") REFERENCES "paitent"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "reviews" ADD CONSTRAINT "reviews_paitentId_fkey" FOREIGN KEY ("paitentId") REFERENCES "paitent"("id") ON DELETE CASCADE ON UPDATE CASCADE;
